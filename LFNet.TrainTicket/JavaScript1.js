...
(function($) {
    ...
    function aj() {
        ...
        jq({
            url: '/otsweb/loginAction.do?method=el', data: dobj, type: 'POST', success: function(data, textStatus) { if (timmer) clearInterval(timmer); },
    ...
    $(document).ready(function() {
        (function() {
            ...
            dobj['jsv'] = window.helperVersion;
            jq({
                url: '/otsweb/loginAction.do?method=el', data: dobj, type: 'POST',
