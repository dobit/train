                                        ...
                                        if (resState.ErrMsg.Equals("Y"))
                                        {
                                            ...
                                            do
                                            {
                                                ...
                                                if (dispTime <= 0)
                                                {
                                                    ...
                                                    switch (dispTime)
                                                    {
                                                        case -1:
                                                            ...
                                                            Common.EmailSender.Send("dobit@qq.com", "买到票了", "买到票了", true,
                                                                                    "dobit购票程序");
                                                        PlayMusic();
                                                        MessageBox.Show(msg);
                                                        Stop = true;
                                                        ...
                                                        default:
                                                            ...
                                                            Common.EmailSender.Send("dobit@qq.com", "可能买到票了", "可能买到票了", true,
                                                                                   "dobit购票程序");
                                                            break;
                                                    }
                                                    return;
                                                ...
                                                if (dispTime == nextRequestTime)
                                                {
                                                    ...
                                                    {
                                                        if (!string.IsNullOrEmpty(waitResponse.OrderId))
                                                        {
                                                            string msg = string.Format("购买成功，订单号：{0}", waitResponse.OrderId);
                                                            Log(account, optimizeTrain.TrainNo + msg);
                                                            Common.EmailSender.Send("dobit@qq.com", "买到票了", "买到票了", true,
