...
namespace LFNet.TrainTicket
{
    public partial class Form1 : Form
    {
        ...
        //{
        //    if (Stop) return;
        //    while (!Stop && account.CheckState() == LoginState.Maintenance)
        //    {
        ...
        private void btnOpenExplorer_Click(object sender, EventArgs e)
        {
            ...
            CookieCollection cookieCollection = client.Cookie.GetCookies(new Uri("https://dynamic.12306.cn/otsweb/"));
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            Task<bool> login = this.client.Login();
        }
